/** biome-ignore-all lint/complexity/noBannedTypes: whatever */
/** biome-ignore-all lint/performance/noNamespaceImport: whatever */
/** biome-ignore-all lint/suspicious/noExplicitAny: whatever */
...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: copied from elsewhere
