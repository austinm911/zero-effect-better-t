 ...
 * @category models
 */
export class EffectPgConnection<R = never>
	implements DBConnection<PgClient.PgClient>
{
	...
	transaction<TRet>(
		...
		const transactionAdapter = new EffectPgTransaction<R>(
			this.#pgClient,
			this.#runtime,
		)
 ...
 * @category models
 */
class EffectPgTransaction<R = never>
	implements DBTransaction<PgClient.PgClient>
{
...
export const TypeId: unique symbol = Symbol.for(
	"@openfaith/zero-effect/ZeroStore",
)
 ...
 * @category tags
 */
export const ZeroStore: Context.Tag<ZeroStore, ZeroStore> =
	Context.GenericTag<ZeroStore>("@openfaith/zero/ZeroStore")
